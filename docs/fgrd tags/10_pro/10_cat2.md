...
1. Description
    - Refers to pronouns that denote a single entity.
2. Tag
    - `sg`
3. Examples
...
1. Description
    - efers to pronouns that denote more than one entity.
2. Tag
    - `pl`
3. Examples
    ...
    - *And so it suited <ins>**them**</ins> to find the Irish hot-headed, rude, and nomadic, the perfect foil to set off their own virtues*. (MICUSP ENG.G1.05.1, Written)
