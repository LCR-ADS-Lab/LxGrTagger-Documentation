...
2. Tag
    - `thatcls+vcomp` (including a ZERO complementizer) is tagged on the **main verb** within the *that*-complement clause.
3. Examples
...
2. Tag
    - `thatcls+BEcomp` is tagged on the **main verb** within the *that*-complement clause.
3. Examples
...
2. Tag
    - `xtrapos+thatcls+vcomp` is tagged on the **main verb** within the *that*-complement clause.
3. Examples
...
1. Descriptions
    - *wh*-clauses can be either (1) dependent interrogative clauses or (2) nominal relative clauses (p. 683).
...
2. Tag
    - `whcls+BEcomp` is tagged on the **main verb** within the *wh*-complement clause.
3. Examples
...
Verb complement clauses are dependent clauses that serve to complete the meaning of a verb in a main clause (e.g., *I think <ins>that this doc looks good</ins>*; *that*-clause functions as a complement to the verb *think*). These clauses are also called **nominal clauses** because they frequently occupy a noun phrase slot in the sentence, acting as subjects, objects, or predicatives. Depending on the controlling predicate, they occur in both pre-predicate (subject) and post-predicate (e.g., direct object) positions (For more information, see Chapter 9).
