...
1. Descriptions
   - Adjective + *to* complement clauses introduce an infinitive verb following *to*.
   - Adjective + *to* complement clauses provide more information about the state or quality described by the adjective, and can specify potential actions or conditions related to the subject.
2. Tag
   - `tocls+jcomp` is tagged on the **main verb** of the *to* complement clause.
3. Examples
...
1. Descriptions
   - Extraposed adjective + *to* complement clauses semantically function as the predicate and the subject.
...
3. Examples
   ...
   - *It is important <ins>to **understand** other people's feelings</ins> in a team environment.*
