...
1. Descriptions
    - An *ing*-clause can function as an adverbial modifying a verb, an adjective, or an entire sentence. It is often used to add information about time, manner, reason, condition, or circumstance of the action described by the main verb.
...
- *I was sleeping right under the fan on Chad’s bed, <ins>with a big bust of Goethe **staring** at me</ins>.*
   ...
   - **A:** The ‘with’-phrase is definitely a PP-adverbial. But this example is tricky to decide on the function of the ING-clauses. The best guess (based on the context) is that these are prepositional complement clauses. The NP preceding the *ing*-verbs functions as the subject of the non-finite clause.
...
1. Descriptions
    - An *ed*-clause can be used as an adverbial to modify a verb, an adjective, or an entire sentence. This is often used to add information about comparisons, levels of expectation, or other modification of the action described by the main verb.
2. Tag
...
3. Examples
   ...
   - *We measured a seasonal total of 56.99 of precipitation” in the two caged rain gauges, <ins>**compared** to 56.78 cm on the open plots.</ins>*
...
- *Hirschman has noted that “the assimilation perspective, <ins>broadly **defined**</ins>, continues to be the primary theoretical framework…”*
   ...
   - **A:** We would agree with the second analysis. It is interpreted as the non-finite *ed-*clause is modifying the head noun ‘perspective’.  
